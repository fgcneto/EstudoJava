...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries4 = new TreeSet<>(new CompararPorNome());
        ...
        Set<Serie> minhasSeries5 = new TreeSet<>(new CompareTempo());
...
class CompararPorNome implements Comparator<Serie>{
    @Override
